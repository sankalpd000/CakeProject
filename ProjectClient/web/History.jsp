<%-- 
    Document   : History
    Created on : 1 Oct, 2022, 7:14:59 PM
    Author     : SankalpD
--%>
...
<%@page import="com.cakeClient.helper.OrderListMyDelivery" %>
<!DOCTYPE html>
<html>
    <head>
      ...
      <div class="container">
                    <ul class="responsive-table">
                      <li class="table-header">
                       ...
                       <% 
            // code product list
            OrderListMyDelivery p = new OrderListMyDelivery();
           ...
           orderDetails.get(i).getId();
            ...
            <form action="confirmation.jsp">  
                        ...
                        <input type="hidden" name="cust" value="<%= orderDetails.get(i).getCustomer() %> />
                        ...
                        <div class="col col-5" data-label=""><input type="submit" value="confirm" /></div>
                      </li>
            </form>
                      <%}%>
                  </ul>    
